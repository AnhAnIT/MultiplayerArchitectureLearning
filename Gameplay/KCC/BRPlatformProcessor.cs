namespace MultiplayCore
{
    ...
    public unsafe sealed class BRPlatformProcessor : NetworkKCCProcessor, IKCCProcessor, IBeginMove, IEndMove
    {
        ...
        [SerializeField]
        [Tooltip("How long it takes to move the KCC from world space to platform space.")]
        private float _platformSpaceTransitionDuration = 0.75f;
        [SerializeField]
        [Tooltip("How long it takes to move the KCC from platform space to world space.")]
